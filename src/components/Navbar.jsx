        ...
        <ul className="nav_links">
          <li className="nav-item">
            ...
            >
              <span>
                ...
                />
                <span>{/* <FontAwesomeIcon icon={faMale} size={7}/> */}</span>
                Male
              </span>
            </NavLink>
          </li>
          ...
          <li className="nav-item">
            <NavLink
              ...
              aria-current="page"
              to="freedomFighters"
              onClick={() => changeCategory("freedomFighters")}
            >
              <span>
                <img
                  src={female}
                  ...
                  className="icon-image img-fluid"
                />
                <span>{/* <FontAwesomeIcon icon={faFemale} size={7}/> */}</span>
                Freedom Fighters
              </span>
            </NavLink>
          </li>
          ...
          <li className="nav-item">
            <NavLink
              ...
              aria-current="page"
              to="disabled"
              onClick={() => changeCategory("disabled")}
            >
              <span>
                <img
                  src={disable}
            ...
            >
              <span>
                <img
                  ...
                  className="icon-image img-fluid"
                />
                <span>{/* <FontAwesomeIcon icon={faBlind} size={7}/> */}</span>
                Woman/OldAged(65+)
              </span>
            </NavLink>
          </li>
