      ...
      {reportPhase === true ? (
        ...
        <div className="row">
                ...
                <tbody>
                  ...
                  {formHousing ? (
                    <tr>
                      ...
                      <td className="withoutInputFields">
                        <p className="text-center">
                          {taxConfig.lessAmount.maxHousingPercentage}% of basic
                          or less of{" "}
                          {format.format(taxConfig.lessAmount.maxHousing)}
                        </p>
                      </td>
                      <td className="withoutInputFields">
                        <p className="text-center">
                  ...
                  {formMedical ? (
                    <tr>
                      ...
                      <td className="withoutInputFields">
                        <p className="text-center">
                          {taxConfig.lessAmount.maxMedicalPercentage}% of basic
                          or less of{" "}
                          {format.format(taxConfig.lessAmount.maxMedical)}
                        </p>
                      </td>
                      <td className="withoutInputFields">
                        <p className="text-center">
          ...
          <div className="col-4 update_form">
            <form ref={updateForm} onSubmit={handleSubmit(handleFormData)}>
              {/* field-no : 1 */}
              ...
              <div className="form-group">
                    ...
                    <select
                      className="form-control"
                        ...
                        <option value="oldAge"
                        selected={"oldAge" === formData.category}
                        >Female/OldAge(65+)</option>
                        <option value="freedomFighters"
                        selected={"freedomFighters" === formData.category}
                        >Gazetted Freedom Fighters</option>
