...
const EmployeeDetailsAsOutputTable = () => {
  return (
    <>
                ...
                <table className="table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="td_of_Output_Table">Mr. Xyz</td>
                      {/* right -  1*/}
                      <th className="th_of_Output_Table">Branch</th>
                      <td className="td_of_Output_Table">Mirpur dohs</td>
                    </tr>
                    {/* 2nd item */}
                    <tr>
                      {/* left - 2*/}
                      <th className="th_of_Output_Table">Employee Code</th>
                      <td className="td_of_Output_Table">viva000000120</td>
                      {/* right -  2*/}
                    ...
                    <tr>
                      ...
                      <td className="td_of_Output_Table">Dhaka</td>
                      {/* right -  3*/}
                      <th className="th_of_Output_Table">Eligible for</th>
                      <td className="td_of_Output_Table">12 Months</td>
                    </tr>
                    {/* 4th item */}
                    <tr>
                      {/* left - 4 */}
                      <th className="th_of_Output_Table">Department</th>
                      <td className="td_of_Output_Table">Developer</td>
                      {/* right -  4*/}
                      <th className="th_of_Output_Table">Gender</th>
                      <td className="td_of_Output_Table">Male</td>
                    </tr>
                    {/* 5th item */}
                    <tr>
                      {/* left - 5*/}
                      <th className="th_of_Output_Table">Join Date</th>
                      <td className="td_of_Output_Table">12 Aug, 2021</td>
                      {/* right -  5*/}
